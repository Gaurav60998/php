            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="usermanage.php" class="nav-item nav-link active">Usermanage</a>
                        ...
                        <a href="q.php" class="nav-item nav-link active">Quey</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>{$row['mrp']}</td>";
                echo "<td><img src='breakfast/{$row['image']}' alt='Breakfast Image' style='max-width: 100px; max-height: 100px;'></td>";
                echo "<td><a href='editbreakfast.php?id={$row['id']}'class='btn btn-lg btn-success'>Edit</a></td>";
                echo "<td><a href='deletebreakfast.php?id={$row['id']}' class='btn btn-lg btn-danger'>Delete</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
