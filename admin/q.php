...
<div class="container mt-4">
    <h1 class="text-center">Query Management</h1>
...
<tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <td>{$row['id']}</td>
                    ...
                    <td>{$row['message']}</td>
                    <td>{$row['reply']}</td>
                    <td><a href='queryreply.php?id={$row['id']}' class='btn btn-lg btn-primary'>Reply</a></td>
                    <td><a class='btn btn-lg btn-danger' href='deletequery.php?id={$row['id']}'>Delete</a></td>
                    </tr>";
        }
        ?>
        </tbody>
