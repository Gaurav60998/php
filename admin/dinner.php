    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='editdinner.php?id={$row['id']}'class='btn btn-lg btn-success'>Edit</a></td>";
                echo "<td><a class='btn btn-lg btn-danger' href='deletedinner.php?id={$row['id']}'>Delete</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
